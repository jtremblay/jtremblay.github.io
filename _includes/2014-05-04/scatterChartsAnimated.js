...
function scatterCharts() {
    ...
    var heightLegend = 80 - marginLegend.top - marginLegend.bottom;
    var widthLegend = 200 - marginLegend.right - marginLegend.left;
    ...
    function chart(selection){
        selection.each(function () {
            ...
            */
            ...
            domLegend = d3.select("#legendAreaScatter")
            ...
            var marginSlider = {top:50, right:50, bottom:0, left:50},
                widthSlider = 960 - marginSlider.left - marginSlider.right,
                heightSlider = 500 - marginSlider.top - marginSlider.bottom;
            ...
            var domSlider = d3.select("#slider")
            var svgSlider = domSlider.append("svg")
            ...
            //var svgPlayButton = playButton.append("svg")
            //    .attr("width", widthSlider + marginSlider.left + marginSlider.right)
            //    .attr("height", heightSlider + marginSlider.top + marginSlider.bottom);
            ...
            slider.append("line")
              ...
              .select(function() { return this.parentNode.appendChild(this.cloneNode(true)); })
                ...
                .call(d3.drag()
                    ...
                    .on("start drag", function() { hue(xScaleTime.invert(d3.event.x)); })
                    //.on("start drag", function() {
                    //  currentValue = d3.event.xScaleTime;
                    //  //update(xScaleTime.invert(currentValue)); 
                    //})
                );
            ...
            /////
            function step() {
              updateSlider(xScaleTime.invert(currentValue));
            ...
            function updateSlider(h) {
              ...
              var newData = data.filter(function(d) {
                //console.log("date:" + d.Date);console.log("h:" + h);
                if(d.Date  h){
